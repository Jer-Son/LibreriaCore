...
namespace TestDb.Controllers
{
    public class PrestamoesController : Controller
    {
        ...
        public PrestamoesController(TestDbContext context)
        {
            _context = context;
        }
        ...
        {
            var testDbContext = _context.Prestamo.Include(p => p.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("IdPrestamo,fechaInicio,fechaFinal,UsuarioId")] Prestamo prestamo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPrestamo,fechaInicio,fechaFinal,UsuarioId")] Prestamo prestamo)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TestDbContext.Prestamo'  is null.");
            }
            var prestamo = await _context.Prestamo.FindAsync(id);
            if (prestamo != null)
            {
